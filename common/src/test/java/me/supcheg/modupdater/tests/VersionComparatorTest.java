...
public class VersionComparatorTest {
    ...
    public void testAll(@NotNull VersionComparator comparator) {
        testNormal(comparator);
        testReserved(comparator);
        testTransforming(comparator);
    }

    public void testNormal(@NotNull VersionComparator comparator) {
    ...
    public void testReserved(@NotNull VersionComparator notReversedComparator) {
    ...
    public void assertResult(@NotNull Comparator<JsonObject> comparator, @NotNull String ver1, @NotNull String ver2, @NotNull ComparingResult expectedResult) {
        assertResult(comparator, createObject(ver1), createObject(ver2), expectedResult);
    }

    public static @NotNull JsonObject createObject(@NotNull String version) {
